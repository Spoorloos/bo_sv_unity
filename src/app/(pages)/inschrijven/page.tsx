            ...
            <form className="w-full max-w-sm space-y-3" action="/" method="POST">
                <fieldset>
                    ...
                    <div className="flex flex-wrap gap-3">
                        <input className="text-field flex-1 w-full min-w-[min(100%,9rem)]" type="text" name="first_name" placeholder="Voornaam" required/>
                        <input className="text-field flex-1 w-full min-w-[min(100%,9rem)]" type="text" name="last_name" placeholder="Achternaam" required/>
                    </div>
                </fieldset>
                <div>
