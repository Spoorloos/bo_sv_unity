    ...
    return (
        <section className="h-full overflow-auto flex flex-col justify-around items-center gap-8 md:flex-row">
            <div className="text-center md:text-left max-w-md space-y-3">
                <h1 className="text-[min(17vw,5rem)] font-bold font-kinetika leading-none text-drop">S.V. Unity</h1>
                <p className="text-[min(7vw,1.25rem)] font-thin">De MBO studentenvereniging van Amsterdam, waar vriendschap, groei en onvergetelijke ervaringen samenkomen!</p>
